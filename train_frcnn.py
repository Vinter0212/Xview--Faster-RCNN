...
if __name__ == "__main__":
    ...
    model_classifier.compile(optimizer=optimizer_classifier, loss=[losses.class_loss_cls, losses.class_loss_regr(
        len(classes_count)-1)], metrics={f'dense_class_{len(classes_count)}': 'accuracy'})
            ...
            try:
                ...
                if iter_num == epoch_length:
                    ...
                    if C.verbose:
                        ...
                        print(
                            f'Classifier accuracy for bounding boxes from RPN: {class_acc}')
                    ...
                    if curr_loss < best_loss:
                        ...
                        best_loss = curr_loss
                    model_all.save_weights(model_path_regex.group(
                        1) + "_" + '{:04d}'.format(epoch_num) + model_path_regex.group(2))
